...
# 네이버 지오코딩 API 인증 정보
NAVER_CLIENT_ID = os.environ.get("NAVER_CLIENT_ID", "c1aa37d3m8")
NAVER_CLIENT_SECRET = os.environ.get("NAVER_CLIENT_SECRET", "JmH6eooePU2Q6xIIPS5AULkiqs20JxHTk5Qm9JeE")

# ODsay 대중교통 API 인증 정보
ODSAY_API_KEY = os.environ.get("ODSAY_API_KEY", "NhnDTQ/ewo1u5ZxHj7RaC0qjtwsmkqrLtNLVE6oMWGM")
